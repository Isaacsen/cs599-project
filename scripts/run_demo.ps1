...
Write-Host "`n[Software Engineer Agent Demo] Run code review agent"
& $Python -m src.review examples/review_target --output docs/runs/review.json

Write-Host "`n[Software Engineer Agent Demo] Generate bug fix plan"
& $Python -m src.fix examples/review_target --output docs/runs/fix_plan.json

Write-Host "`n[Software Engineer Agent Demo] Generate missing unit tests"
